...
public class BaseException extends Exception {
    ...
    public static final int ERROR_API_SYSTEM = 10000; //服务器错误
    public static final int ERROR_API_LOGIN = 10001; //登录错误
    public static final int ERROR_API_NO_PERMISSION = 10002; //调用无权限的api
    public static final int ERROR_API_ACCOUNT_FREEZE = 10003; //账户冻结
